...
//-----------------------------
//Base addresses for NVIC CORTEX M3 CPU
//-----------------------------
...
//-*-*-*-*-*-*-*-*-*-*-*-
//clock enable Macros: SPI
//-*-*-*-*-*-*-*-*-*-*-*

#define RCC_SPI1_CLK_EN()			(RCC->APB2ENR |=	1<<12 )
#define RCC_SPI2_CLK_EN()			(RCC->APB1ENR |=	1<<14 )
//-*-*-*-*-*-*-*-*-*-*-*-
//clock RESET Macros: SPI
//-*-*-*-*-*-*-*-*-*-*-*
...
//-*-*-*-*-*-*-*-*-*-*-*-
//NVIC IRQ Enable/Disable MACROS :	SPI
//-*-*-*-*-*-*-*-*-*-*-*
...
//-*-*-*-*-*-*-*-*-*-*-*-
//NVIC IRQ Enable/Disable MACROS :	I2C
//-*-*-*-*-*-*-*-*-*-*-*
