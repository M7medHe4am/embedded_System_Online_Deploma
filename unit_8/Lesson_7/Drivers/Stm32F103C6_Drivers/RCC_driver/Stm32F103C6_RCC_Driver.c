...
uint32_t MCAL_RCC_getAHBCLKFreq(void)
{
	...
	return ( MCAL_RCC_getSYSCLKFreq() >> AHBTABLE[(RCC->CFGR >> 4)  & 0b1111] )	;
...
uint32_t MCAL_RCC_getAPB1CLKFreq(void)
{
	...
	return ( MCAL_RCC_getAHBCLKFreq()	>> APBTABLE[(RCC->CFGR >> 8 ) & 0b111 ]	);
...
//	Bits 13:11 PPRE2: APB high-speed prescaler (APB2)
	return (MCAL_RCC_getAHBCLKFreq()	>> APBTABLE[(RCC->CFGR >> 11 ) & 0b111 ])	;
